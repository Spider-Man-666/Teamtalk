package com.mogujie.tt.ui.custom;
...
public class ClearableEditTextWithIcon extends AppCompatEditText implements OnTouchListener, TextWatcher {
    ...
    // 删除符号
    Drawable deleteImage = getResources().getDrawable(R.mipmap.icon_wrong);
    ...
    public void setIconResource(int id) {
        ...
        Log.e("蒋超", "setIconResource: " + icon.getIntrinsicWidth()  + "      "  + icon.getIntrinsicHeight());
