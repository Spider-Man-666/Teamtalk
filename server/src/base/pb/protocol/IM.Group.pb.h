...
inline void InitDefaults() {
  InitDefaultsIMNormalGroupListReq();
  InitDefaultsIMNormalGroupListRsp();
  InitDefaultsIMGroupInfoListReq();
  InitDefaultsIMGroupInfoListRsp();
  InitDefaultsIMGroupCreateReq();
  InitDefaultsIMGroupCreateRsp();
  InitDefaultsIMGroupChangeMemberReq();
  InitDefaultsIMGroupChangeMemberRsp();
  InitDefaultsIMGroupShieldReq();
  InitDefaultsIMGroupShieldRsp();
  InitDefaultsIMGroupChangeMemberNotify();
}
}  // namespace protobuf_IM_2eGroup_2eproto
namespace IM {
namespace Group {
